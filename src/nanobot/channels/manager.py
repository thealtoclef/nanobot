...
class ChannelManager:
    ...
    async def _send_once(channel: BaseChannel, msg: OutboundMessage) -> None:
        ...
        elif not msg.metadata.get("_streamed") or msg.content:
            # Send if not already streamed, OR if content is non-empty (edge case: streaming
            # was requested but produced no deltas, so the final content is still unsent)
